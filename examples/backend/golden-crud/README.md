...
- Replace table names, permission codes, menu resource entries, and operation log actions.
- Add or update tests for the generated endpoints.

The example demonstrates the TrueAdmin standard CRUD shape:

- Controller: route attributes, permission metadata, operation logs, response wrapping.
...
- Menu resource: backend-owned menu and button entries in `resources/menus.php`.
