...
它参考 MineAdmin 一类后台系统的功能形态，但技术栈重新选择为更适合长期演进的组合：后端使用 Hyperf，Web 管理端使用 React、Umi Max、Ant Design Pro 与 Ant Design，移动端预留 uni-app、Vue 3、TypeScript 与 Wot UI。
...
TrueAdmin/
  ...
  web/                React + Umi Max + Ant Design Pro + Ant Design 管理端目录预留
