...
- 复制已经稳定进入 `trueadmin/kernel` 的分页、API envelope、FormRequest、CrudQueryRequest、DataPolicy runtime、Controller 默认基类、Permission middleware runtime、默认 ExceptionHandler 和运行时服务
- 承载模块业务事实
