...
#[Menu(code: 'system.notificationManagement', title: '通知管理', path: '/system/notification-management', parent: 'system', permission: 'system:notification:list', icon: 'bell', sort: 80)]
