...
#[Menu(code: 'system.notificationManagement', title: '通知管理', path: '/system/notification-management', parent: 'system', permission: 'system:notification:list', component: './system/notification-management', icon: 'bell', sort: 80)]
