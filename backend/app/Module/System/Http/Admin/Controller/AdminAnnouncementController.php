...
#[Menu(code: 'system.announcementManagement', title: '公告管理', path: '/system/announcement-management', parent: 'system', permission: 'system:announcement:list', component: './system/announcement-management', icon: 'notification', sort: 85)]
