...
#[Menu(code: 'system.client-users', title: '用户端账号', path: '/system/client-users', parent: 'system', permission: 'system:client-user:list', component: './system/client-users', sort: 25)]
